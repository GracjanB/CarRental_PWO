...
import AvailableComponent from "../components/Dashboard/AvailableComponent";
import RentComponent from "../components/Dashboard/RentComponent";
...
export default {
  ...
  data() {
    return {
      ...
      isUser: ((this.getCookie("loginname") == "admin1")?null:1),
    };
  },
  methods:{
